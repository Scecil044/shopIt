...
const mock = [
  {
    ...
    image:
      "https://ke.jumia.is/unsafe/fit-in/500x500/filters:fill(white)/product/08/8404381/1.jpg?7492",
  },
  {
    text: "32' Vision Plus Television Set. HDMI, USB3",
    image:
      "https://ke.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/12/368634/1.jpg?6303",
  },
  {
    text: "TECNO POP 52 6' OLED AndoidOne",
    image:
      "https://ke.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/49/8408771/1.jpg?5432",
  },
  {
    text: "Vitron V27 8CLP .night vision display light",
    image:
      "https://ke.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/91/908043/1.jpg?5225",
  },
  {
    text: "Hikers 32' inch Television. OLED display",
    image:
      "https://ke.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/74/687398/1.jpg?5827",
  },
  {
...
export default function BrowsingHistory() {
  return (
    <div className="">
      <h1 className="ml-5 font-semibold">Inspired By Your Browsing History</h1>
