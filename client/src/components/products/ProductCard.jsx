...
export default function ProductCard() {
  return (
    <div className="grid grid-cols-5 gap-3 snap-x overflow-x-scroll no-scrollbar min-w-[800px]">
        ...
        >
          <Link to="/product" className="overflow-hidden">
            <img
              src={product.image}
              alt="..."
              className="h-[180px] md:h-[200px] object-cover hover:scale-105 transition-all duration-500"
            />
          </Link>
          <div>
