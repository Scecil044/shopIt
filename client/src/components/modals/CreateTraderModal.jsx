...
export default function CreateTraderModal({ openModal, setOpenModal }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.businessName) {
      setBusinessNameError("The business name field is required!");
    } else {
    ...
    <div className="inset-0 fixed bg-black/50 w-full h-full flex items-center justify-center">
      ...
      >
        <div className="flex items-center justify-between mb-1">
          <h1 className="font-bold text-lg">Create Trader</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            {cityError && !formData.city && (
              <small className="text-red-600 font-semibold">{cityError}</small>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`py-1 px-2 focus:ring-0 focus:outline-none border border-gray-400 ${
                businessNameError ? "border border-red-700" : ""
              }`}
            />
            {businessNameError && !formData.businessName && (
              <small className="text-red-600 font-semibold">
                {businessNameError}
              </small>
            )}
        ...
        {/* modal footer */}
        <div className="mt-2 flex items-center gap-2 flex float-end">
          <button
